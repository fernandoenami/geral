...
namespace PushService
{
    ...
    public class SampleService : ISampleContract
    {
        ...
        public void Subscribe()
        {
            ...
            TimerCallback tc = new TimerCallback(timer_execute);
            Timer t = new Timer(tc, null, 1000, 1000);
        }

        private void timer_execute(object state)
        {
            PublishPriceChange(DateTime.Now.Second.ToString(), DateTime.Now.Second, DateTime.Now.Second);
        }
