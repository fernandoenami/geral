...
Bar.prototype = {
    constructor: Bar,
    executeCallback: function (_callback)
    {
        //this.time = _time;
        //this.o = _o;
...
Datafeeds.JSApiCompatibleDataFeed.prototype.subscribeBars = function(symbolInfo, resolution, onRealtimeCallback, listenerGUID, bar) {
    this._bar.executeCallback(onRealtimeCallback);

    //this._addBarFunction = onRealtimeCallback;
    //if (onRealtimeCallback === "function")
    //    onRealtimeCallback(bar);
    //this._logMessage("subscribe feito");
    //this._addBar(onRealtimeCallback, i);
    //this._barsPulseUpdater.subscribeDataListener(symbolInfo, resolution, onRealtimeCallback, listenerGUID);
//var i = { time: 1e3 * parseInt(1475452800), open: 10, high: 12, low: 13, close: 18, volume: 21056200 };
//onRealtimeCallback(i);
//i = { time: 1e3 * parseInt(1475539200), open: 20, high: 22, low: 23, close: 28, volume: 21056200 };
//onRealtimeCallback(i);
};
...
//Datafeeds.JSApiCompatibleDataFeed.prototype._addBarFunction = function () { };
//Datafeeds.JSApiCompatibleDataFeed.prototype._addBar = function (bar)
//{
//    this._addBarFunction(bar);
//    this._logMessage("onRealtimeCallback feito");
////    if (onRealtimeCallback === "function")
////        onRealtimeCallback(bar);
//};
